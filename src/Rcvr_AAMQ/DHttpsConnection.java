...
public class DHttpsConnection 
{
   ...
   public static void main(String args[]) throws JSONException
   {
       ...
       String jsonData=user.toString();
       DHttpPostReq httpPostReq=new DHttpPostReq();
...
class DHttpPostReq
{
	...
	static Logger log = DLogMQ.monitor("Rcvr_AAMQ.HttpPostReq");
